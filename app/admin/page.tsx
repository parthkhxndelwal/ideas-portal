  ...
  return (
    <AdminLayout title="Main Dashboard">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {adminActions.map(({ title, description, icon: Icon, action }, i) => (
          <Card
            key={i}
            onClick={action}
            className="cursor-pointer transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] hover:-translate-y-1 border border-neutral-200/50 dark:border-neutral-700/50 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-md hover:bg-white/90 dark:hover:bg-neutral-900/90 hover:border-neutral-300/60 dark:hover:border-neutral-600/60 group"
          >
            <CardContent className="flex items-start gap-4 p-5">
              {/* Icon */}
              <div className="p-3 rounded-md bg-transparent text-neutral-700 dark:text-neutral-300 transition-all duration-300 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/20 group-hover:text-blue-600 dark:group-hover:text-blue-400 group-hover:scale-110">
